...
class TestQ:
    def test_expects_pairs(self):
        with pytest.raises(TypeError):
            bayesian.state_q([1, 2, 3, 4])
...
class TestWiths:
    def test_success(self):
        history = [(1, 2), (3, 4), (5, 0)]
        assert bayesian.with_success(history, 1) == [(1, 2), (4, 4), (5, 0)]

    def test_failure(self):
        history = [(1, 2), (3, 4), (5, 0)]
        assert bayesian.with_failure(history, 1) == [(1, 2), (3, 5), (5, 0)]
